...
class LayoutKTextForm @JvmOverloads constructor(
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        attrs?.let {
            ...
            _isRequire = typedArray.getBoolean(R.styleable.LayoutKTextForm_layoutKTextForm_isRequired, _isRequire)
            _requiredIconPos =
                typedArray.getInteger(R.styleable.LayoutKTextForm_layoutKTextForm_requiredIconPos, _requiredIconPos)
            _label = typedArray.getString(R.styleable.LayoutKTextForm_layoutKTextForm_label)
            _labelTextSize = typedArray.getDimensionPixelSize(
                R.styleable.LayoutKTextForm_layoutKTextForm_labelTextSize,
                _labelTextSize
            )
            _labelColor = typedArray.getColor(R.styleable.LayoutKTextForm_layoutKTextForm_labelColor, _labelColor)
            _labelMarginLeft = typedArray.getDimensionPixelOffset(
                R.styleable.LayoutKTextForm_layoutKTextForm_labelMarginLeft,
                _labelMarginLeft
            )
            _labelMarginRight = typedArray.getDimensionPixelOffset(
                R.styleable.LayoutKTextForm_layoutKTextForm_labelMarginRight,
                _labelMarginRight
            )
            _labelWidth =
                typedArray.getDimensionPixelOffset(R.styleable.LayoutKTextForm_layoutKTextForm_labelWidth, _labelWidth)
            _textHint = typedArray.getString(R.styleable.LayoutKTextForm_layoutKTextForm_textHint)
            _textColor = typedArray.getColor(R.styleable.LayoutKTextForm_layoutKTextForm_textColor, _textColor)
            _textSize = typedArray.getDimensionPixelSize(R.styleable.LayoutKTextForm_layoutKTextForm_textSize, _textSize)
            _borderBackground =
