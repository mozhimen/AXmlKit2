...
class LayoutKTextEditForm @JvmOverloads constructor(
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        attrs?.let {
            ...
            _isRequire =
                typedArray.getBoolean(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_isRequired, _isRequire)
            _requireIconPos =
                typedArray.getInteger(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_isRequired, _requireIconPos)
            _label =
                typedArray.getString(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_label)
            _labelTextSize =
                typedArray.getDimension(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_labelTextSize, _labelTextSize)
            _labelColor =
                typedArray.getColor(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_labelColor, _labelColor)
            _labelMarginLeft =
                typedArray.getDimensionPixelSize(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_labelMarginLeft, _labelMarginLeft)
            _labelMarginRight =
                typedArray.getDimensionPixelSize(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_labelMarginRight, _labelMarginRight)
            _labelWidth =
                typedArray.getDimensionPixelSize(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_labelWidth, _labelWidth)
            _editHint =
                typedArray.getString(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_editHint)
            _editType =
                typedArray.getInteger(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_editType, _editType)
            _editColor =
                typedArray.getColor(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_editColor, _editColor)
            _editSize =
                typedArray.getDimension(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_editSize, _editSize)
            _borderBackground =
            ...
            _borderBackgroundFocus =
                typedArray.getResourceId(R.styleable.LayoutKTextEditForm_layoutKTextEditForm_borderBackgroundHasFocus, _borderBackgroundFocus)
            typedArray.recycle()
        }
    }
