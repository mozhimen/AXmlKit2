package com.mozhimen.xmlk2.layoutk.text
...
import com.mozhimen.xmlk2.layoutk.R
...
class LayoutKTextForm @JvmOverloads constructor(
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        attrs?.let {
            val typedArray = context.obtainStyledAttributes(attrs, R.styleable.LayoutKTextForm)
            _isRequire =
                typedArray.getBoolean(R.styleable.LayoutKTextForm_layoutKTextForm_isRequired, _isRequire)
            _requiredIconPos =
                typedArray.getInteger(R.styleable.LayoutKTextForm_layoutKTextForm_requiredIconPos, _requiredIconPos)
            _label =
                typedArray.getString(R.styleable.LayoutKTextForm_layoutKTextForm_label)
            _labelTextSize =
                typedArray.getDimension(R.styleable.LayoutKTextForm_layoutKTextForm_labelTextSize, _labelTextSize)
            _labelColor =
                typedArray.getColor(R.styleable.LayoutKTextForm_layoutKTextForm_labelColor, _labelColor)
            _labelMarginLeft =
                typedArray.getDimensionPixelOffset(R.styleable.LayoutKTextForm_layoutKTextForm_labelMarginLeft, _labelMarginLeft)
            _labelMarginRight =
                typedArray.getDimensionPixelOffset(R.styleable.LayoutKTextForm_layoutKTextForm_labelMarginRight, _labelMarginRight)
            _labelWidth =
                typedArray.getDimensionPixelOffset(R.styleable.LayoutKTextForm_layoutKTextForm_labelWidth, _labelWidth)
            _textHint =
                typedArray.getString(R.styleable.LayoutKTextForm_layoutKTextForm_textHint)
            _textColor =
                typedArray.getColor(R.styleable.LayoutKTextForm_layoutKTextForm_textColor, _textColor)
            _textSize =
                typedArray.getDimension(R.styleable.LayoutKTextForm_layoutKTextForm_textSize, _textSize)
            _borderBackground =
                typedArray.getResourceId(R.styleable.LayoutKTextForm_layoutKTextForm_borderBackground, _borderBackground)
            typedArray.recycle()
        }
    }
    ...
    override fun initView() {
        LayoutInflater.from(context).inflate(R.layout.layoutk_text_form, this)
