package com.mozhimen.xmlk2.viewk
...
class ViewKQRScan2 @JvmOverloads constructor(
    ...
    override fun initAttrs(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        _borderWidth =
            typedArray.getDimension(R.styleable.ViewKQRScan2_viewKQRScan2_borderWidth, _borderWidth)
        _borderColor =
            typedArray.getColor(R.styleable.ViewKQRScan2_viewKQRScan2_borderColor, _borderColor)
        _lineDrawable =
            typedArray.getDrawable(R.styleable.ViewKQRScan2_viewKQRScan2_lineDrawable)
        _lineWidth =
            typedArray.getDimensionPixelSize(R.styleable.ViewKQRScan2_viewKQRScan2_lineWidth, _lineWidth)
        _lineColor =
            typedArray.getColor(R.styleable.ViewKQRScan2_viewKQRScan2_lineColor, _lineColor)
        _animTime =
            typedArray.getInteger(R.styleable.ViewKQRScan2_viewKQRScan2_animTime, _animTime)
        _distance =
            typedArray.getDimensionPixelSize(R.styleable.ViewKQRScan2_viewKQRScan2_distance, _distance)
        _isLineReverse =
            typedArray.getBoolean(R.styleable.ViewKQRScan2_viewKQRScan2_isLineReverse, _isLineReverse)
        _successDrawable =
            typedArray.getResourceId(R.styleable.ViewKQRScan2_viewKQRScan2_isLineReverse, _successDrawable)
        _successDrawableSize =
            typedArray.getDimension(R.styleable.ViewKQRScan2_viewKQRScan2_successDrawableSize, _successDrawableSize)
        _successAnimTime =
